...
void VoteViewController::viewDidLoad()
{
	...
	btn->addTarget(this, CAControl_selector(VoteViewController::buttonCallBack), CAControlEventTouchUpInSide);
...
void VoteViewController::requestMsg() // all(0) track(1) format(2) my_all(3)
{
	if (m_alertView) {
...
void VoteViewController::showAlert()
{
	...
	btn5->addTarget(this, CAControl_selector(VoteViewController::buttonCallBack), CAControlEventTouchUpInSide);
