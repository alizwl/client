...
void MyStatusViewController::viewDidLoad()
{
	...
	btn->addTarget(this, CAControl_selector(MyStatusViewController::buttonCallBack), CAControlEventTouchUpInSide);
...
void MyStatusViewController::requestMsg() // all(0) track(1) format(2) my_all(3)
{
	if (m_alertView) {
