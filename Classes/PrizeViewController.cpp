...
void PrizeViewController::viewDidLoad()
{
	...
	btn->addTarget(this, CAControl_selector(PrizeViewController::buttonCallBack), CAControlEventTouchUpInSide);
...
void PrizeViewController::requestMsg() // all(0) track(1) format(2) my_all(3)
{
	if (m_alertView) {
